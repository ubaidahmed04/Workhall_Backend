...
router.use('/app/', attendanceRoutes);
router.use('/app/', markAttendanceRoutes);
router.use('/app/report', reportRoutes);
router.use('/app/', taskRoutes);
router.use('/app/', getTaskRoutes);
router.use('/app/', branchRoutes);
router.use('/app/', clientRoutes);
router.use('/app/', employeeRoutes);
router.use('/app/', leaveTypeRoutes);
router.use('/app/', employeeLeaveRoutes);
router.use('/app/', applyLeaveRoutes);
router.use('/app/', payslipRoutes);
router.use('/app/', rolePermissionRoutes);
router.use('/app/', monthReportRoutes);
router.use('/app/', attendanceTodayRoutes);
router.use('/app/', taskReportRoutes);
router.use('/app/', departmentRoutes);
router.use('/app/', allempleaveRoutes);
router.use('/app/', logoutRoutes);
router.use('/app/', forgetPasswordRoutes);
router.use('/app/', generateOtpRoutes);
router.use('/app/', verifyOtpRoutes);
router.use('/app/', sendOtpRoutes);
